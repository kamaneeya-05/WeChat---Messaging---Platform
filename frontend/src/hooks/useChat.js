...
import { setConversations, setActiveConversation, setActiveMessages, addMessage, updateMessageAsDeleted, addConversation, markConversationRead, markMyMessagesReadInChat } from '../store/features/chatSlice';
...
export function useChat() {
    ...
    const sendMessage = useCallback(async (text, file = null) => {
        ...
        if ((!text.trim() && !file) || !activeConversation || !socket)
            return;
        try {
            let responseData;

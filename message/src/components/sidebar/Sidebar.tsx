...
export default function Sidebar({ conversations, activeId, onSelect, currentUser }: SidebarProps) {
  ...
  return (
    <aside className="w-72 flex-shrink-0 bg-gray-50 flex flex-col h-full border-r border-gray-200">
      ...
      <div className="border-t border-gray-200 px-3 py-3 relative" ref={userMenuRef}>
        <button
          ...
          className="w-full flex items-center gap-3 p-2 rounded-xl hover:bg-gray-200 transition group"
        >
        ...
        {showUserMenu && (
          <div className="absolute bottom-full left-3 right-3 mb-2 bg-white rounded-xl overflow-hidden border border-gray-200 text-sm shadow-xl z-50">
